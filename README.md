...
- 🌍 **Application** — https://ecoride-app-studi.duckdns.org
- 📧 **Mailpit** — http://ecoride-app-studi.duckdns.org:8026
- 🗄️ **phpMyAdmin** — http://ecoride-app-studi.duckdns.org:8082

## Stack technique
- **Backend** — PHP 8.x, Symfony 7.x
...
## État du projet
✅ Application fonctionnelle avec authentification et sécurité Symfony  
✅ Déploiement Docker sur serveur AWS  
✅ Base de données MariaDB avec interface d'administration  
